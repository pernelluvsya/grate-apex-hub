(function(){
  ...
  function applyTheme(){ var d=load(); var lvl=rankFor(d.xp).lvl;
  ...
  function recordAnswer(key, correct, pq){ var d=load(); var oldXp=d.xp;
  ...
  function toggleTheme(){ var d=load(); var lvl=rankFor(d.xp).lvl;
